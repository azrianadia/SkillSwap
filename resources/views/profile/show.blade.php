            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6">
                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="flex flex-col items-center -mt-16 mb-4">
                        ...
                        @else
                            <div class="w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-4xl font-bold text-white shadow-lg border-4 border-white">
